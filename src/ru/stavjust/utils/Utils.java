/*
 * IOUtils.java - Класс методов-утилит
 *
...
import ru.stavjust.dbutils.DBUrlReader;
...
public class Utils {
	...
	public static ImageIcon getIcon(String iconName) {
		if (Utils.class.getResource(String.format(
				"/ru/stavjust/ui/resources/%s.png", iconName)) == null)
			iconName = "pixel";
		return new ImageIcon(Utils.class.getResource(String.format(
				"/ru/stavjust/ui/resources/%s.png", iconName)));
	}
